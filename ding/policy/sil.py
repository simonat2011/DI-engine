...
class SIL(Policy):
    ...
    def __init__(self, policy: Policy, cfg):
        print(policy._enable_field)
        self.base_policy = policy
        self._model = policy._model
        super(SIL, self).__init__(cfg.policy, model=policy._model,
                                  enable_field=policy._enable_field)
    ...
    def _load_state_dict_learn(self, state_dict: Dict[str, Any]) -> None:
        self.base_policy._load_state_dict_learn()
